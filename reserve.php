...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf(
    "INSERT INTO reservations (rsrv_id, rsrv_timestamp, rsrv_first_name, rsrv_last_name, rsrv_email, rsrv_contact, rsrv_room, rsrv_bed, rsrv_pillow, rsrv_towel, rsrv_kit, rsrv_start, rsrv_end, rsrv_guest, rsrv_notes) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysqli_query($insertSQL, $localhost) or die(mysqli_error("localhost"));
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="rsrv_form">
          ...
          <fieldset>
            ...
            <span id="sprytextfield5">
              ...
              <span class="textfieldRequiredMsg">Please select a date.</span></span><br />
            <!-- <div class="check_avail"><a href="">Check Availability</a></div> -->
          </fieldset>
